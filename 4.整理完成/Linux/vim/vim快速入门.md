...
![1](https://doc.shiyanlou.com/document-uid49570labid16timestamp1491030562304.png)
...
## <font color='red'>进入插入模式</font>font
...
| ---------------------------- | ---------------------------------------- |
| `i`                          | 在当前光标处进行编辑                     |
| <font color='red'>`I`</font> | <font color='red'>在行首插入</font>      |
| <font color='red'>`A`</font> | <font color='red'>在行末插入</font>      |
| `a`                          | 在光标后插入编辑                         |
| `o`                          | 在当前行后插入一个新行                   |
| `O`                          | 在当前行前插入一个新行                   |
...
![1](https://doc.shiyanlou.com/document-uid49570labid16timestamp1491030616700.png)
