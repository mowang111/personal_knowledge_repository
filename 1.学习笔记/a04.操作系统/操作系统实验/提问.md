...
```
0x84b3 <fprintk+97>     push   %fs                                                                                           │
   │0x84b5 <fprintk+99>     push   %ds                                                                                           │
   │0x84b6 <fprintk+100>    pop    %fs                                                                                           │
   │0x84b8 <fprintk+102>    mov    0x18(%esp),%edi                                                                               │
   │0x84bc <fprintk+106>    mov    0x14(%esp),%esi                                                                               │
   │0x84c0 <fprintk+110>    mov    0x10(%esp),%ebx                                                                               │
